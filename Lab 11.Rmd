...
A. Compute Pearson’s 𝑟
r
 and report the associated p-value using the cor.test() function. (2 points)
...
cor.test(X,Y)
```
B. #generate null-distribution of r values
...
hist(sim_rs)
```
#find pvalue of getting that corr.
